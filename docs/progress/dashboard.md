...
| `CACHE-001` | Thumbnail & cache management | planned | Implement CacheManager defaults and LRU eviction example in pk_py_lib.core.cache | 2025-08-14 | [`img-app-data-model.md`](docs/roo/img-app-data-model.md), [`img-app-specification.md`](docs/roo/img-app-specification.md) |  |
