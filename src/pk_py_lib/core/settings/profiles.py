"""
src/pk_py_lib/core/settings/profiles.py

DEPRECATED: Settings Profiles manager - consolidated into unified SettingsManager.

This module is deprecated. Use src.pk_py_lib.core.settings.manager.SettingsManager instead.
...
class SettingsProfilesManager:
    ...
    def __init__(self, db_manager: DatabaseManager):
        ...
        import warnings
        warnings.warn(
            "SettingsProfilesManager is deprecated. Use SettingsManager from src.pk_py_lib.core.settings.manager instead.",
            DeprecationWarning,
            stacklevel=2
        )
        self.db = db_manager
