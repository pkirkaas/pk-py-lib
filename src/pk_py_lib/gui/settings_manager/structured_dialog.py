...
class _NamePromptDialog(QDialog):
    ...
    @log_errors(include_args=True, include_traceback=True)
    @gui_error_handler(component_name="_NamePromptDialog")
    def text(self) -> str:
        try:
    ...
    def _build_ui(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._build_ui"
            )
            raise
    ...
    def _refresh_profiles(self, select_active: bool = False, preserve_selection: bool = True) -> None:
        ...
        try:
            ...
            handle_gui_error(
                ...
                error=e,
                title="Refresh Error",
                component_name="StructuredSettingsManagerDialog._refresh_profiles"
            )
            raise
    ...
    def _load_profile(self, profile_id: str) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._load_profile",
    ...
    def _on_list_selection_changed(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_list_selection_changed"
            )
    ...
    def _on_dirty_changed(self, dirty: bool) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_dirty_changed",
                dirty=dirty
            )
    ...
    def _on_profile_selected(self, index: int) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_profile_selected",
                index=index
            )
    ...
    def _on_create(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_create"
            )
    ...
    def _on_rename(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_rename",
    ...
    def _on_duplicate(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_duplicate",
                profile_id=self._current_profile_id
            )
    ...
    def _on_delete(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_delete",
                profile_id=self._current_profile_id
            )
    ...
    def _on_set_active(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_set_active",
                profile_id=self._current_profile_id
            )
    ...
    def _on_apply(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_apply",
                profile_id=self._current_profile_id
            )
    ...
    def _on_ok(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_ok"
            )
    ...
    def _on_cancel(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._on_cancel"
            )
    ...
    def _select_by_id(self, profile_id: str) -> None:
        try:
            ...
            handle_gui_error(
                ...
                error=e,
                title="Selection Error",
                component_name="StructuredSettingsManagerDialog._select_by_id",
                profile_id=profile_id
            )
    ...
    def _reselect_current(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._reselect_current",
                profile_id=self._current_profile_id
            )
    ...
    def _update_action_states(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._update_action_states"
            )
    ...
    def _show_empty_state_hint(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="StructuredSettingsManagerDialog._show_empty_state_hint"
            )
    ...
    def _prompt_save_discard_cancel(self, question: str) -> str:
        ...
        try:
            ...
            handle_gui_error(
                ...
                error=e,
                title="Prompt Error",
                component_name="StructuredSettingsManagerDialog._prompt_save_discard_cancel",
                question=question
            )
    ...
    def _maybe_prompt_save_discard_cancel(self) -> bool:
        ...
        try:
            ...
            handle_gui_error(
                ...
                error=e,
                title="Prompt Error",
                component_name="StructuredSettingsManagerDialog._maybe_prompt_save_discard_cancel"
            )
