...
class KeyValueEditDialog(QDialog):
    ...
    def __init__(
        ...
        try:
            ...
            handle_gui_error(
                parent=parent,
                error=e,
                title="Dialog Initialization Error",
                component_name="KeyValueEditDialog"
            )
            raise

    @log_errors(include_args=True, include_traceback=True)
    @gui_error_handler(component_name="KeyValueEditDialog")
    def _validate_key_inline(self) -> None:
        try:
            ...
            self.lbl_key_error.setText("Validation error")
    ...
    def _on_accept(self) -> None:
        try:
            ...
            self.lbl_value_error.setText(f"Invalid JSON: {json_e}")
            logger.warning(
            ...
            handle_gui_error(
                ...
                error=e,
                title="Accept Error",
                component_name="KeyValueEditDialog._on_accept"
            )
    ...
    def result_value(self) -> Tuple[str, Any]:
        ...
        try:
            ...
            handle_gui_error(
                ...
                error=e,
                title="Result Error",
                component_name="KeyValueEditDialog.result_value"
            )
            raise
    ...
    def __init__(self, api: Optional[UnifiedSettingsAPI] = None, parent: Optional[QWidget] = None):
        ...
        try:
            ...
            handle_gui_error(
                ...
                component_name="SettingsProfileEditorWidget"
            )
            raise

    # ------------------------------------------------------------------ UI ----
    @log_errors(include_args=True, include_traceback=True)
    @gui_error_handler(component_name="SettingsProfileEditorWidget")
    def _build_ui(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="SettingsProfileEditorWidget._build_ui"
            )
            raise
    ...
    def load_profile(self, profile: Dict[str, Any], values: Dict[str, Any]) -> None:
        ...
        try:
            ...
            handle_gui_error(
                ...
                component_name="SettingsProfileEditorWidget.load_profile"
            )
            raise
    ...
    def reset_dirty(self) -> None:
        ...
        try:
            ...
            handle_gui_error(
                ...
                component_name="SettingsProfileEditorWidget.reset_dirty"
            )
    ...
    def gather_changes(self) -> Tuple[Optional[str], Optional[str], Optional[Dict[str, Any]], Optional[Sequence[str]]]:
        ...
        try:
            ...
            handle_gui_error(
                ...
                component_name="SettingsProfileEditorWidget.gather_changes"
            )
    ...
    def _on_meta_changed(self) -> None:
        try:
            ...
            handle_gui_error(
                parent=self,
                error=e,
                title="Metadata Change Error",
                component_name="SettingsProfileEditorWidget._on_meta_changed"
            )
    ...
    def _on_add(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="SettingsProfileEditorWidget._on_add",
    ...
    def _on_edit(self) -> None:
        try:
            ...
            handle_gui_error(
                ...
                component_name="SettingsProfileEditorWidget._on_edit"
            )
    ...
    def _on_remove(self) -> None:
        try:
            ...
            handle_gui_error(
                parent=self,
                error=e,
                title="Remove Items Error",
                component_name="SettingsProfileEditorWidget._on_remove",
                num_keys=len(keys) if 'keys' in locals() else 0
            )
